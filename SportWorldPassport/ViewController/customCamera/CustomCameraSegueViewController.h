//
//  CustomCameraSegueViewController.h
//  SportWorldPassport
//
...
@interface CustomCameraSegueViewController  : DBCameraBaseCropViewController <DBCameraCropRect, DBCameraSegueSettings, DBCameraViewControllerSettings>
/**
